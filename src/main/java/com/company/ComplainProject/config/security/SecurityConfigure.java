...
public class SecurityConfigure extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/api/checkToken").permitAll()
                .antMatchers("/api/login").permitAll()
                .antMatchers(HttpMethod.POST,"/api/send/otp").permitAll()
                .antMatchers(HttpMethod.GET,"/api/getAllOtp").permitAll()
                .antMatchers("/api/updatePassword").permitAll()
                .antMatchers("/api/testing12").permitAll()
