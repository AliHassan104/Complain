...
function getComplain() {
    ...
    .then((data)=> {
        ...
        <th style="width: 90%;" class="toptable ">User</th>
        <th style="width: 90%;" class="toptable ">Question</th>
        <th style="width: 90%;" class="toptable ">Answer</th>
        <th style="width: 90%;" class="toptable ">Action</th>
        </tr>`
        for (let i = 0; i < data.length; i++) {
            ...
            if (data[i].user != null || data[i].pollingQuestion != null || data[i].pollingOption != null ) {
                ...
                <td style="width: 90%;" class="datatable">${data[i].user.firstname+" "+data[i].user.lastname}</td>
                <td style="width: 90%;" class="datatable">${data[i].pollingQuestion.question}</td>
                <td style="width: 90%;" class="datatable">${data[i].pollingOption.option}</td>
