...
function renderArea(data) {
    ...
    <tr class="tablepoint "  >
        ...
        if(canEdit){
            table +=`
            <a  href="/viewarea.html?id=${data.content[i].id}"> 
            ...
            if(canDelete){
                 table +=  `<i id="close12" onclick="deleteArea(${data.content[i].id})"   class="fa fa-close"></i>`
    ...
    if(data.content.length === 0){
        ...
        class="alert alert-danger" role = "alert" > No Area Found</ > `
